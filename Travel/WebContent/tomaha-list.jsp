...
<body class="js">
 <%@ include file="header.jsp" %>
    ...
    <section class="avacus-blogpage-area section-padding">
        <div class="container">
            <div class="row">
                 <%ArrayList<ToursBean> activelist = (ArrayList<ToursBean>)request.getAttribute("tomahlist"); 
			                         if(activelist==null)
			                         {
			         ...
			         <%
			         				int i=1;
			                          for(ToursBean bn :activelist){
			                        	  if(bn.getTours_status().equalsIgnoreCase("1") && bn.getTours_type().equalsIgnoreCase("2"))
				                        	 {
			                        	  %>  
