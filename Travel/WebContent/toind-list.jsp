...
<body class="js">
 <%@ include file="header.jsp" %>
    ...
    <section class="avacus-blogpage-area section-padding">
        <div class="container">
            <div class="row">
                 <%ArrayList<ToursBean> activelist = (ArrayList<ToursBean>)request.getAttribute("toindlist"); 
			                         if(activelist==null)
			                         {
			         ...
			         <%
			         				int i=1;
			                          for(ToursBean bn :activelist){
			                        	  if(bn.getTours_status().equalsIgnoreCase("1") && bn.getTours_type().equalsIgnoreCase("3"))
				                        	 {
			                        	  %>  
				...
				<div class="col-sm-3">
                    <div class="single-news single-grid">
                        <div class="news-thumb">
                               <a href="#"><img src="fetchGallery?type=UserPhoto&image=<%=(bn.getTours_img()!=null)?bn.getTours_img():""%>" ></a>
                        </div>
                        <a href="#"><h3><%=bn.getTours_name()!=null?bn.getTours_name():""%></h3></a>
